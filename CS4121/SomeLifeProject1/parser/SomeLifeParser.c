...
#line 51 "SomeLifeParser.y"
{
			printf("programHead -> PROGRAM %s ; decls\n",yymsp[-2].minor.yy0->name);
		}
#line 916 "SomeLifeParser.c"
        break;
      case 3: /* decls ::= VAR declList */
#line 57 "SomeLifeParser.y"
{
			printf("decls -> VAR declList\n");
		}
#line 923 "SomeLifeParser.c"
        break;
      case 4: /* decls ::= */
#line 62 "SomeLifeParser.y"
{
			printf("decls -> epsilon\n");
		}
#line 930 "SomeLifeParser.c"
        break;
      case 5: /* procedures ::= procedureDecl procedures */
#line 67 "SomeLifeParser.y"
{
			printf("procedures -> procedures procedureDecl\n");
		}
#line 937 "SomeLifeParser.c"
        break;
      case 6: /* procedures ::= */
#line 72 "SomeLifeParser.y"
{
			printf("procedures -> epsilon\n");
		}
#line 944 "SomeLifeParser.c"
        break;
      case 7: /* procedureDecl ::= procedureHead compoundStatement SEMICOLON */
#line 77 "SomeLifeParser.y"
{
			printf("procedureDecl -> procedureHead compoundStatement ;\n");
		}
#line 951 "SomeLifeParser.c"
        break;
      case 8: /* procedureHead ::= functionDecl decls */
#line 82 "SomeLifeParser.y"
{
			printf("procedureHead -> functionDecl decls\n");
		}
#line 958 "SomeLifeParser.c"
        break;
      case 9: /* functionDecl ::= FUNCTION IDENTIFIER COLON type SEMICOLON */
#line 87 "SomeLifeParser.y"
{
			printf("functionDecl -> FUNCTION %s : standardType ;\n",yymsp[-3].minor.yy0->name);
		}
#line 965 "SomeLifeParser.c"
        break;
      case 10: /* declList ::= identifierList COLON type SEMICOLON */
#line 93 "SomeLifeParser.y"
{
			printf("declList -> identifierList : type ;\n");
		}
#line 972 "SomeLifeParser.c"
        break;
      case 11: /* declList ::= declList identifierList COLON type SEMICOLON */
#line 98 "SomeLifeParser.y"
{
	  		printf("declList -> declList identifierList : type ;\n");
	 	}
#line 979 "SomeLifeParser.c"
        break;
      case 12: /* identifierList ::= IDENTIFIER */
#line 104 "SomeLifeParser.y"
{
			printf("identifierList -> %s\n",yymsp[0].minor.yy0->name);
		}
#line 986 "SomeLifeParser.c"
        break;
      case 13: /* identifierList ::= identifierList COMMA IDENTIFIER */
#line 109 "SomeLifeParser.y"
{
			printf("identifierList -> identifierList , %s\n",yymsp[0].minor.yy0->name);
		}
#line 993 "SomeLifeParser.c"
        break;
      case 14: /* type ::= standardType */
#line 114 "SomeLifeParser.y"
{ 
			printf("type -> standardType\n");
		}
#line 1000 "SomeLifeParser.c"
        break;
      case 15: /* type ::= arrayType */
#line 119 "SomeLifeParser.y"
{ 
			printf("type -> arrayType\n");
		}
#line 1007 "SomeLifeParser.c"
        break;
      case 16: /* standardType ::= INTEGER */
#line 124 "SomeLifeParser.y"
{ 
			printf("standardType -> INTEGER\n");
		}
#line 1014 "SomeLifeParser.c"
        break;
      case 17: /* standardType ::= FLOAT */
#line 129 "SomeLifeParser.y"
{ 
			printf("standardType -> FLOAT\n");
		}
#line 1021 "SomeLifeParser.c"
        break;
      case 18: /* arrayType ::= ARRAY LBRACKET dim RBRACKET OF standardType */
#line 134 "SomeLifeParser.y"
{
			printf("arrayType -> ARRAY [ dim ] OF standardType\n");
		}
#line 1028 "SomeLifeParser.c"
        break;
      case 19: /* dim ::= INTNUM DOTDOT INTNUM */
#line 139 "SomeLifeParser.y"
{
			printf("dim -> %s .. %s\n",yymsp[-2].minor.yy0->name,yymsp[0].minor.yy0->name);
		}
#line 1035 "SomeLifeParser.c"
        break;
      case 20: /* statement ::= matched_stmt */
#line 144 "SomeLifeParser.y"
{
			printf("statement -> matched_stmt\n");
		}
#line 1042 "SomeLifeParser.c"
        break;
      case 21: /* statement ::= open_stmt */
#line 148 "SomeLifeParser.y"
{
			printf("statement -> open_stmt\n");
		}
#line 1049 "SomeLifeParser.c"
        break;
      case 22: /* matched_stmt ::= matched_if */
#line 153 "SomeLifeParser.y"
{
			printf("matched_stmt -> matched_if\n");
		}
#line 1056 "SomeLifeParser.c"
        break;
      case 23: /* matched_stmt ::= assignment */
#line 157 "SomeLifeParser.y"
{
			printf("matched_stmt  -> assignment\n");
		}
#line 1063 "SomeLifeParser.c"
        break;
      case 24: /* matched_stmt ::= matchedWhileStatement */
#line 161 "SomeLifeParser.y"
{
			printf("matched_stmt -> matchedWhileStatement\n");
		}
#line 1070 "SomeLifeParser.c"
        break;
      case 25: /* matched_stmt ::= ioStatement */
#line 165 "SomeLifeParser.y"
{
			printf("matched_stmt -> ioStatement \n");
		}
#line 1077 "SomeLifeParser.c"
        break;
      case 26: /* matched_stmt ::= returnStatement */
#line 169 "SomeLifeParser.y"
{
			printf("matched_stmt -> returnStatement\n");
		}
#line 1084 "SomeLifeParser.c"
        break;
      case 27: /* matched_stmt ::= compoundStatement */
#line 173 "SomeLifeParser.y"
{
			printf("matched_stmt -> compoundStatement\n");
		}
#line 1091 "SomeLifeParser.c"
        break;
      case 28: /* assignment ::= variable ASSIGN expr */
#line 178 "SomeLifeParser.y"
{
			printf("assignment -> variable ASSIGN expr\n");
		}
#line 1098 "SomeLifeParser.c"
        break;
      case 29: /* matched_if ::= IF testAndThen ELSE matched_stmt */
#line 183 "SomeLifeParser.y"
{
			printf("matched_if -> IF testAndThen ELSE matched_stmt\n");
		}
#line 1105 "SomeLifeParser.c"
        break;
      case 30: /* open_stmt ::= IF test THEN statement */
#line 188 "SomeLifeParser.y"
{
			printf("open_stmt ->  IF test THEN statement\n");
		}
#line 1112 "SomeLifeParser.c"
        break;
      case 31: /* open_stmt ::= IF testAndThen ELSE open_stmt */
#line 193 "SomeLifeParser.y"
{
			printf("open_stmt -> IF testAndThen ELSE open_stmt\n");
		}
#line 1119 "SomeLifeParser.c"
        break;
      case 32: /* open_stmt ::= openWhileStatement */
#line 198 "SomeLifeParser.y"
{
			printf("open_stmt -> openWhileStatement\n");
		}
#line 1126 "SomeLifeParser.c"
        break;
...
#line 1133 "SomeLifeParser.c"
        break;
      case 34: /* test ::= expr */
#line 208 "SomeLifeParser.y"
{
			printf("test -> expr\n");
		}
...
#line 213 "SomeLifeParser.y"
{
			printf("matchedWhileStatement -> whileToken whileExpr DO matched_stmt\n");
		}
#line 1147 "SomeLifeParser.c"
        break;
      case 36: /* openWhileStatement ::= whileToken whileExpr DO open_stmt */
#line 218 "SomeLifeParser.y"
{
			printf("openWhileStatement -> whileToken whileExpr DO open_stmt\n");
		}
#line 1154 "SomeLifeParser.c"
        break;
      case 37: /* whileExpr ::= expr */
#line 223 "SomeLifeParser.y"
{
			printf("whileExpr -> expr\n");
		}
#line 1161 "SomeLifeParser.c"
        break;
      case 38: /* whileToken ::= WHILE */
#line 228 "SomeLifeParser.y"
{
...
#line 318 "SomeLifeParser.y"
{
			printf("simpleExpr -> simpleExpr GT addExpr\n");
		}
#line 1294 "SomeLifeParser.c"
        break;
...
#line 1329 "SomeLifeParser.c"
        break;
      case 62: /* mulExpr ::= mulExpr DIVIDE factor */
#line 348 "SomeLifeParser.y"
{
			printf("mulExpr ->  mulExpr DIVIDE factor\n");
		}
#line 1336 "SomeLifeParser.c"
        break;
      case 63: /* factor ::= variable */
#line 353 "SomeLifeParser.y"
{ 
			printf("factor	-> variable\n");
		}
#line 1343 "SomeLifeParser.c"
        break;
      case 64: /* factor ::= constant */
#line 358 "SomeLifeParser.y"
{ 
			printf("factor -> constant\n");
		}
#line 1350 "SomeLifeParser.c"
        break;
      case 65: /* factor ::= IDENTIFIER LPAREN RPAREN */
#line 363 "SomeLifeParser.y"
{	
...
#line 368 "SomeLifeParser.y"
{
			printf("factor -> LPAREN expr RPAREN\n");
		}
#line 1364 "SomeLifeParser.c"
        break;
      case 67: /* variable ::= IDENTIFIER */
#line 373 "SomeLifeParser.y"
{
			printf("variable -> %s\n",yymsp[0].minor.yy0->name);
		}
#line 1371 "SomeLifeParser.c"
        break;
      case 68: /* variable ::= IDENTIFIER LBRACKET expr RBRACKET */
#line 378 "SomeLifeParser.y"
{
			printf("variable -> %s LBRACKET expr RBRACKET\n",yymsp[-3].minor.yy0->name);
               	}
#line 1378 "SomeLifeParser.c"
        break;
      case 69: /* stringConstant ::= STRING */
#line 383 "SomeLifeParser.y"
{ 
			printf("stringConstant -> STRING\n");
		}
#line 1385 "SomeLifeParser.c"
        break;
      case 70: /* constant ::= FLOATCON */
#line 388 "SomeLifeParser.y"
{ 
			printf("constant -> FLOATCON\n");
		}
#line 1392 "SomeLifeParser.c"
        break;
      case 71: /* constant ::= INTNUM */
#line 393 "SomeLifeParser.y"
{ 
			printf("constant -> INTNUM\n");
		}
#line 1399 "SomeLifeParser.c"
        break;
      default:
        break;
  };
...
#line 28 "SomeLifeParser.y"

  SomeLife_error("Syntax Error");
#line 1464 "SomeLifeParser.c"
  SomeLife_ParseARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
