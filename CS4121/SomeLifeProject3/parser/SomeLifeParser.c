...
{
			//symtab = currentSymtab(symtabStack);
			...
			//calculate size of array and put that into the proper
			//field
...
#line 1123 "SomeLifeParser.c"
        break;
      case 28: /* assignment ::= variable ASSIGN expr */
#line 251 "SomeLifeParser.y"
{
...
#line 1222 "SomeLifeParser.c"
        break;
      case 43: /* compoundStatement ::= T_BEGIN statementList END */
#line 346 "SomeLifeParser.y"
{

	        }
#line 1229 "SomeLifeParser.c"
        break;
...
#line 355 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			yygotominor.yy0->symIndex = yymsp[0].minor.yy0->symIndex; 
			free(yymsp[0].minor.yy0);
		}
#line 1241 "SomeLifeParser.c"
        break;
      case 47: /* expr ::= expr OR simpleExpr */
#line 362 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1251 "SomeLifeParser.c"
        break;
      case 48: /* expr ::= expr AND simpleExpr */
#line 370 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1270 "SomeLifeParser.c"
        break;
      case 51: /* simpleExpr ::= simpleExpr EQ addExpr */
#line 392 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1290 "SomeLifeParser.c"
        break;
      case 53: /* simpleExpr ::= simpleExpr LE addExpr */
#line 408 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1300 "SomeLifeParser.c"
        break;
      case 54: /* simpleExpr ::= simpleExpr LT addExpr */
#line 416 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1310 "SomeLifeParser.c"
        break;
      case 55: /* simpleExpr ::= simpleExpr GE addExpr */
#line 424 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1320 "SomeLifeParser.c"
        break;
      case 56: /* simpleExpr ::= simpleExpr GT addExpr */
#line 432 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1330 "SomeLifeParser.c"
        break;
      case 58: /* addExpr ::= addExpr PLUS mulExpr */
#line 447 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1340 "SomeLifeParser.c"
        break;
      case 59: /* addExpr ::= addExpr MINUS mulExpr */
#line 455 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1360 "SomeLifeParser.c"
        break;
      case 62: /* mulExpr ::= mulExpr DIVIDE factor */
#line 478 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1370 "SomeLifeParser.c"
        break;
      case 63: /* factor ::= variable */
#line 486 "SomeLifeParser.y"
{ 
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			yygotominor.yy0->symIndex = emitLoadVariable(instList,symtab,yymsp[0].minor.yy0->symIndex);
			free(yymsp[0].minor.yy0);
		}
#line 1379 "SomeLifeParser.c"
        break;
      case 64: /* factor ::= constant */
#line 493 "SomeLifeParser.y"
{ 
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			yygotominor.yy0->symIndex = yymsp[0].minor.yy0->symIndex;
			free(yymsp[0].minor.yy0);
		}
#line 1388 "SomeLifeParser.c"
        break;
      case 65: /* factor ::= IDENTIFIER LPAREN RPAREN */
#line 500 "SomeLifeParser.y"
{
			//TODO:caller pre-call
			//find the right symtab and use it
			SymTable symtab_current = findSymtab(symtabStack,yymsp[-2].minor.yy0->name);
			int symIndex = SymQueryIndex(symtab_current,yymsp[-2].minor.yy0->name);
...
#line 1404 "SomeLifeParser.c"
        break;
      case 66: /* factor ::= LPAREN expr RPAREN */
#line 514 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			yygotominor.yy0->symIndex = yymsp[-1].minor.yy0->symIndex;
			free(yymsp[-1].minor.yy0);
		}
#line 1413 "SomeLifeParser.c"
        break;
      case 67: /* variable ::= IDENTIFIER */
#line 521 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute)); 
			//find the correct symtab and use it
			SymTable symtab_current = findSymtab(symtabStack,yymsp[0].minor.yy0->name);
			int symIndex = SymQueryIndex(symtab_current,yymsp[0].minor.yy0->name);
			yygotominor.yy0->symIndex =emitComputeVariableAddress(instList,symtab_current,symtab_current,symIndex);
			free(yymsp[0].minor.yy0);
		}
#line 1425 "SomeLifeParser.c"
        break;
      case 68: /* variable ::= IDENTIFIER LBRACKET expr RBRACKET */
#line 531 "SomeLifeParser.y"
{
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			//find the correct symtab and use it
			SymTable symtab_current = findSymtab(symtabStack,yymsp[-3].minor.yy0->name);
			int symIndex = SymQueryIndex(symtab_current,yymsp[-3].minor.yy0->name);
			yygotominor.yy0->symIndex =
			emitComputeArrayAddress(instList,symtab_current,symIndex,symtab_current,yymsp[-1].minor.yy0->symIndex);
			free(yymsp[-3].minor.yy0);
			free(yymsp[-1].minor.yy0);
               	}
#line 1439 "SomeLifeParser.c"
        break;
      case 69: /* stringConstant ::= STRING */
#line 543 "SomeLifeParser.y"
{ 
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
...
#line 1449 "SomeLifeParser.c"
        break;
      case 71: /* constant ::= INTNUM */
#line 553 "SomeLifeParser.y"
{ 
			yygotominor.yy0 = malloc(sizeof(TokenAttribute));
			int symIndex = SymIndex(symtab,yymsp[0].minor.yy0->name);
