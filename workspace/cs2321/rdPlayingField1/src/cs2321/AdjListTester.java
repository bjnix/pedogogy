...
public class AdjListTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Check replace(Vertex): " + gr.replace(n, "quote"));//-----------qwerty
		...
		System.out.println("Check areAdjacent: " + gr.areAdjacent(s, k));//-----------------true
		System.out.println("Check numVertices: " + gr.numVertices());//---------------------19
		...
		System.out.println("Check vertices: " + gr.vertices());//---------------------------[[sad,11], [gunny,3], [fight,2], [Colds,5], [foonda,1], [BOrg,1], [hahoo,1], [happy,22], [foo,2], [fun,3], [hots,1], [lunny,8], [lappy,3], [poppy,2], [poop,2], [quote,1], [bad,3], [r2d2,1]]
		System.out.println("Check removeVertex: " + gr.removeVertex(b));//------------------sad
		System.out.println("Check numEdges: " + gr.numEdges());//---------------------------26
		System.out.println("Check numVertices: " + gr.numVertices());//---------------------18
		System.out.println("Check removeVertex: " + gr.removeVertex(f));//------------------lunny
		System.out.println("Check numEdges: " + gr.numEdges());//---------------------------20
		System.out.println("Check numVertices: " + gr.numVertices());//---------------------17
		System.out.println("Check removeVertex: " + gr.removeVertex(a));//------------------happy
		System.out.println("Check numEdges: " + gr.numEdges());//---------------------------4
		System.out.println("Check numVertices: " + gr.numVertices());//---------------------16
	}
